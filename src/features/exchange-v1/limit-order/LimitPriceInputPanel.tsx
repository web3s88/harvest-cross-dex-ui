...
const LimitPriceInputPanel: FC<LimitPriceInputPanelProps> = ({ onBlur }) => {
  ...
  return (
    <div
      className={`flex-col md:flex-row flex bg-whitesmoke w-full rounded overflow-hidden h-[110px] md:h-[68px] ${
    ...
    >
      ...
      <div className="flex items-center w-full h-full gap-3 pl-4 pr-5 border-2 rounded bg-white border-dark-800 md:rounded-r">
        <Input.Numeric
          disabled={disabled}
