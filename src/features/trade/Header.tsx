...
const ExchangeHeader: FC<ExchangeHeaderProps> = ({ input, output, allowedSlippage }) => {
  ...
  return (
    <div className="flex items-center justify-between mb-4 space-x-3">
      <div className="grid grid-cols-3 rounded p-3px bg-whitesmoke h-[46px]">
        <NavLink
      ...
      <div className="flex items-center">
        <div className="grid grid-flow-col gap-1">
          {isLimitOrder && (
            <div className="items-center h-full w-full cursor-pointer hover:bg-whitesmoke rounded px-3 py-1.5">
              <MyOrders />
            </div>
          )}
          {chainId === ChainId.MAINNET && (
            <div className="items-center hidden w-full h-full px-3 space-x-3 rounded cursor-pointer text-green text-opacity-80 hover:text-opacity-100 md:flex hover:bg-whitesmoke">
          ...
          <div className="relative flex items-center w-full h-full rounded hover:bg-whitesmoke">
