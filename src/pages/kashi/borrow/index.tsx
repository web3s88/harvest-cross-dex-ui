...
function Borrow() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Borrow`)} | Harvest</title>
        <meta
          key="description"
          name="description"
      ...
      <Card className="h-full bg-white" header={<MarketHeader type="Borrow" lists={[pairs, positions]} />}>
                    ...
                    <div key={pair.address}>
                      <Link href={'/borrow/' + pair.address}>
                        <a className="block text-high-emphesis">
                          <div className="grid items-center grid-cols-4 gap-4 px-4 py-4 text-sm rounded md:grid-cols-6 lg:grid-cols-7 align-center bg-whitesmoke hover:bg-dark-pink">
