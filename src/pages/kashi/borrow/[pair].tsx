...
function Pair() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Borrow ${pair?.asset?.symbol}-${pair?.collateral?.symbol}`)} | Harvest</title>
        <meta
          key="description"
          name="description"
      ...
      >
        ...
        <Tab.Group>
          <Tab.List className="flex p-1 rounded bg-whitesmoke">
            <Tab
              className={({ selected }) =>
                `${
                  selected ? 'bg-white text-high-emphesis' : ''
      ...
      right={
        <Card className="h-full bg-white">
          <div className="flex-col space-y-2">
            ...
            {pair && pair.oracle.name === 'HarvestSwap' && (
              <>
                <div className="flex justify-between pt-3">
