...
function Lend() {
  ...
  return fullPairs ? (
    <>
      ...
      <Card className="h-full bg-white" header={<MarketHeader type="Lending" lists={[pairs, positions]} />}>
  ...
  return (
    <Link href={'/lend/' + pair.address}>
      <a className="block text-high-emphesis">
        <div className="grid items-center grid-flow-col grid-cols-4 gap-4 px-4 py-4 text-sm rounded md:grid-cols-6 lg:grid-cols-7 align-center bg-whitesmoke hover:bg-dark-blue">
