...
const activeTabStyle = `${tabStyle} text-high-emphesis font-bold bg-white`
...
export default function Stake() {
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | Harvest</title>
        <meta
          key="description"
          name="description"
        ...
        />
        <meta key="twitter:url" name="twitter:url" content="https://harvestcapcrosschain.com/stake" />
        ...
        <meta
          ...
          content="Stake SUSHI in return for xSUSHI, an interest bearing and fungible ERC20 token designed to share revenue generated by all SUSHI products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://harvestcapcrosschain.com/xsushi-sign.png" />
        <meta key="og:title" property="og:title" content="STAKE SUSHI" />
        <meta key="og:url" property="og:url" content="https://harvestcapcrosschain.com/stake" />
        <meta key="og:image" property="og:image" content="https://harvestcapcrosschain.com/xsushi-sign.png" />
        <meta
          key="og:description"
        ...
        <div className="flex flex-col justify-center md:flex-row">
          <div className="flex flex-col w-full max-w-xl mx-auto mb-4 md:m-0">
            ...
            <div>
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-white md:pb-9 md:pt-4 md:px-8">
                <div className="flex w-full rounded h-14 bg-whitesmoke">
                  <div
                ...
                <Input.Numeric
                  ...
                  className={classNames(
                    'w-full h-14 px-3 md:px-5 mt-5 rounded bg-whitesmoke text-sm md:text-lg font-bold text-dark-800 whitespace-nowrap caret-high-emphesis',
          ...
          <div className="w-full max-w-xl mx-auto md:mx-0 md:ml-6 md:block md:w-72">
            <div className="flex flex-col w-full px-4 pt-6 pb-5 rounded bg-white md:px-8 md:pt-7 md:pb-9">
