...
export default function Remove() {
  ...
  function modalBottom() {
    return (
      <div className="p-6 mt-0 -m-6 bg-whitesmoke">
        {pair && (
          <>
  ...
  return (
    <Container id="remove-liquidity-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Remove Liquidity | Harvest</title>
        <meta key="description" name="description" content="Remove liquidity from the HarvestSwap AMM" />
      </Head>
      ...
      <DoubleGlowShadow>
        <div className="p-4 space-y-4 rounded bg-white" style={{ zIndex: 1 }}>
          {/* <AddRemoveTabs
          creating={false}
          adding={false}
              ...
              <div>
                ...
                <AutoColumn justify="space-between" className="py-2.5">
                  <AutoRow justify={'flex-start'} style={{ padding: '0 1rem' }}>
                    <button className="z-10 -mt-6 -mb-6 rounded-full cursor-default bg-white p-3px">
                      <div className="p-3 rounded-full bg-whitesmoke">
                ...
                <div id="remove-liquidity-output" className="p-5 rounded bg-whitesmoke">
                  <div className="flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
                    ...
                    <div className="flex flex-col space-y-3 md:flex-row md:space-x-6 md:space-y-0">
                      <div className="flex flex-row items-center w-full p-3 pr-8 space-x-3 rounded bg-white">
