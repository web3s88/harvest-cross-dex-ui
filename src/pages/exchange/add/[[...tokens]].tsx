...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Harvest</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the HarvestSwap AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
          ...
          <div className="p-4 space-y-4 rounded bg-white" style={{ zIndex: 1 }}>
            ...
            <div className="flex flex-col space-y-4">
              ...
              {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                <div className="p-1 rounded bg-whitesmoke">
                  <LiquidityPrice
                    currencies={currencies}
                    price={price}
                    noLiquidity={noLiquidity}
