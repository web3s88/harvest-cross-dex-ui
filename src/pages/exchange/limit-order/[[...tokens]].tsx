...
function LimitOrder() {
  ...
  return (
    <Container id="limit-order-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>{i18n._(t`Limit order`)} | Harvest</title>
        <meta
          name="description"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-row gap-5">
                ...
                <div className="relative flex items-center">
                  <div className="z-0 absolute w-[2px] bg-whitesmoke h-[calc(100%+32px)] top-[-16px] left-[calc(50%-1px)]" />
                  <button
                    className="z-10 rounded-full bg-white p-3px"
                    onClick={() => {
                      onSwitchTokens()
                    }}
                  >
                    <div
                      className="p-2 rounded-full bg-whitesmoke hover:bg-opacity-40"
