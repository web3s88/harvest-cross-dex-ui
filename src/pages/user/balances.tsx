...
function Balances() {
  ...
  return (
    <>
      <Head>
        <title>Balances | Harvest</title>
        <meta key="description" name="description" content="" />
      </Head>
      <Card
        className="h-full bg-white"
        header={
          <Card.Header className="flex items-center justify-between bg-whitesmoke">
...
const TokenBalance = ({ token }: { token: BentoBalance & WrappedTokenInfo }) => {
  ...
  return (
    <Paper className="space-y-4">
      <div
        className="grid grid-cols-3 px-4 py-4 text-sm rounded cursor-pointer select-none bg-whitesmoke"
      ...
      >
        <div className="grid grid-cols-2 gap-4 ">
          <div className="col-span-2 p-4 text-center rounded md:col-span-1 bg-whitesmoke">
            <Deposit token={token} />
          </div>
          <div className="col-span-2 p-4 text-center rounded md:col-span-1 bg-whitesmoke">
