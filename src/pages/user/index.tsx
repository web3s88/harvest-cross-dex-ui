...
export default function Me() {
  ...
  return (
    <Container id="user-page" className="py-4 space-y-3 md:py-8 lg:py-12" maxWidth="2xl">
      ...
      <div className="w-full max-w-2xl p-4 mb-3 rounded bg-white">
        <div className="flex justify-between">
          <div className="flex">
            <div className="p-1.5 bg-whitesmoke rounded">
      ...
      <div className="w-full max-w-2xl p-4 rounded bg-white">
