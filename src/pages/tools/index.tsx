...
export default function Tools() {
  ...
  return (
    <Container id="tools-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="xl">
      <Head>
        <title>Tools | Harvest</title>
        <meta key="description" name="description" content="HarvestSwap tools..." />
      </Head>
      ...
      <ul className="space-y-4 divide-y-0">
        {tools.map((tool) => (
          <li key={tool.id} className="relative w-full p-4 rounded bg-white hover:bg-whitesmoke">
