...
export default function Meowshi() {
  ...
  return (
    <Container id="meowshi-page" className="py-4 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
        <title>Meowshi | Harvest</title>
        <meta key="description" name="description" content="HarvestSwap Meowshi..." />
      </Head>
      ...
      <div className="relative grid gap-4 p-4 border-2 rounded z-1 bg-white shadow-swap border-dark-800">
        ...
        <div className="relative mt-[-24px] mb-[-24px] ml-[28px] flex items-center">
          <div
            className="inline-flex p-2 border-2 rounded-full cursor-pointer border-dark-900 bg-whitesmoke"
