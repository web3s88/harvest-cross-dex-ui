...
function useAllCommonPairs(currencyA?: Currency, currencyB?: Currency): Pair[] {
  ...
  const allPairs = useV2Pairs(allCurrencyCombinations, currencyB?.chainId)
  // currencyB?.chainId == 56 && console.log(allPairs)
...
export function useV2TradeExactOut(
  ...
  // currencyIn?.chainId == 56 && currencyIn.isNative && console.log(allowedPairs, currencyIn, currencyAmountOut?.toExact())
  return useMemo(() => {
