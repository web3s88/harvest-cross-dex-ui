...
const FILLED = {
  ...
  green: 'bg-green bg-opacity-80 w-full rounded hover:bg-opacity-100 disabled:bg-opacity-80 text-white text-bold text-1.2rem',
  gradient:
    'w-full text-high-emphesis bg-gradient-to-r from-blue to-pink opacity-80 hover:opacity-100 disabled:bg-opacity-80',
  primary: 'bg-primary bg-opacity-80 w-full rounded hover:bg-opacity-100 disabled:bg-opacity-80 text-white text-bold text-1.2rem',
}
...
const OUTLINED = {
  ...
  green: 'bg-green bg-opacity-20 border text-white text-bold text-1.2rem border-green rounded hover:bg-opacity-40 disabled:bg-opacity-20',
  primary: 'btn-primary bg-opacity-20 border text-white text-bold text-1.2rem border-green rounded hover:bg-opacity-40 disabled:bg-opacity-20',
  gradient:
...
export type ButtonColor = 'blue' | 'pink' | 'gradient' | 'gray' | 'default' | 'red' | 'green' | 'primary'
...
export function ButtonError({
  ...
  if (error) {
    return <Button color="primary" size="lg" {...rest}/>
  } else {
    return <Button color={disabled ? 'primary' : 'primary'} disabled={disabled} size="lg" {...rest} />
  }
}
