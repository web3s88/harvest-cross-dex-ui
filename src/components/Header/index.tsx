...
import { ANALYTICS_URL, MINTYS_ADDRESS } from '../../constants'
        ...
        {({ open }) => (
          <>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    ...
                    {/*      <div*/}
                    {/*        className="hidden p-0.5 rounded-md cursor-pointer sm:inline-flex bg-white hover:bg-whitesmoke"*/}
                    {/*        onClick={() => {*/}
                    ...
                    {/*{chainId && chainId in MINTYS_ADDRESS && library && library.provider.isMetaMask && (*/}
                    {/*  <>*/}
                    {/*    <QuestionHelper text={i18n._(t`Add MINTY to your MetaMask wallet`)}>*/}
                    {/*      <div*/}
                    {/*        className="hidden rounded-md cursor-pointer sm:inline-flex bg-white hover:bg-whitesmoke p-0.5"*/}
                    {/*        onClick={() => {*/}
                    {/*          const params: any = {*/}
                    {/*            type: 'ERC20',*/}
                    {/*            options: {*/}
                    {/*              address: MINTYS_ADDRESS[chainId],*/}
                    {/*              symbol: 'MINTYS',*/}
                    {/*              decimals: 9,*/}
                    {/*              image: 'https://raw.githubusercontent.com/top1st/token-assets/main/png/mintys.png',*/}
                    {/*            },*/}
                    {/*          }*/}
                    {/*          if (library && library.provider.isMetaMask && library.provider.request) {*/}
                    {/*            library.provider*/}
            ...
            <Popover.Panel className="sm:hidden">
              <div className="flex flex-col px-4 pt-2 pb-3 space-y-1 header-nav">
                <Link href={'/swap'}>
                  <a
                    id={`swap-nav-link`}
                    className="p-2 text-baseline text-primary hover:text-high-emphesis focus:text-high-emphesis md:p-3 whitespace-nowrap"
