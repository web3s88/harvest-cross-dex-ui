  ...
  return (
    <>
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.quotient, JSBI.BigInt(0)) ? (
        <div className="p-5 rounded bg-whitesmoke text-high-emphesis">
          <AutoColumn gap={'md'}>
            ...
            <div className="flex flex-col w-full p-3 mt-3 space-y-1 text-sm rounded bg-white text-high-emphesis">
    ...
    >
      <Button
        ...
        className={classNames(
          'flex items-center justify-between w-full px-4 py-6 cursor-pointer bg-whitesmoke hover:bg-opacity-40',
      ...
      >
        <div className="p-4 space-y-4">
          <div className="px-4 py-4 space-y-1 text-sm rounded text-high-emphesis bg-white">
