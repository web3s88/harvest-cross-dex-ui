...
export default function Updater({ customId }: {customId?: number} ): null {
  ...
  const latestBlockNumber = useBlockNumber(customId)
  const multicall2Contract = useMulticall2Contract(customId)
