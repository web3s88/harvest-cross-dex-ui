...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.MAINNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MAINNET],
    DAI, USDC, USDT,
    // WBTC, RUNE, NFTX, STETH
  ],
  [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC],
    MATIC.USDC,
    // MATIC.WBTC,
    // MATIC.DAI,
    // MATIC.WETH,
  ...
  [ChainId.BSC]: [...WRAPPED_NATIVE_ONLY[ChainId.BSC],
    // BSC.DAI,
    BSC.USD,
    // BSC.USDC,
    BSC.USDT,
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC], MATIC.USDC,
    // MATIC.WBTC, MATIC.DAI, MATIC.WETH,
    MATIC.USDT],
  [ChainId.FANTOM]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM], FANTOM.DAI, FANTOM.USDC, FANTOM.WBTC, FANTOM.WETH],
