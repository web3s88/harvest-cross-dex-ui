...
export const MINTYS: ChainTokenMap = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, MINTYS_ADDRESS[ChainId.MAINNET], 9, 'MINTYS', 'MintySwap'),
  [ChainId.BSC]: new Token(ChainId.BSC, MINTYS_ADDRESS[ChainId.BSC], 9, 'MINTYS', 'MintySwap'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, MINTYS_ADDRESS[ChainId.MATIC], 9, 'MINTYS', 'MintySwap'),
}
...
export const STABLE_USD: {[p: string]: Token} = {
