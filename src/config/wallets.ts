...
export const networks = {
  [ChainId.BSC]: new NetworkConnector({defaultChainId: ChainId.BSC, urls: RPC}),
  [ChainId.MAINNET]: new NetworkConnector({defaultChainId: ChainId.MAINNET, urls: RPC}),
  [ChainId.MATIC]: new NetworkConnector({defaultChainId: ChainId.MATIC, urls: RPC}),
